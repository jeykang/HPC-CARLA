...
class ContinuousCLI:
    ...
    def generate_slurm_script(self, slurm_config: SLURMConfig, 
        ...
        # Get the actual number of GPUs for environment setup
        if slurm_config.gpus_per_node:
            num_gpus = slurm_config.gpus_per_node
        ...
        script_parts.extend([
            ...
            'echo "GPUs allocated: ${SLURM_GPUS_PER_NODE:-$SLURM_GRES}"',
            'echo "=========================================="',
            'echo ""',
            ""
        ])
